...
stopuser = {}
token = '7427494179:AAHCmC6WIzQXG3R6kg9YYueknd7JwaptC3s'
...
''',reply_markup=keyboard)
		...
		''',reply_markup=keyboard)
			...
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text=f"🏴‍☠️ Stripe Charge 🏴‍☠️",callback_data='br')
...
𝗕𝗼𝘁 𝗕𝘆: chk1212</b>'''
					if "insufficient funds" in last or 'Thank you for you support' in last or 'Thank You For Your Support!' in last or 'Thank You' in last or 'thank-you-for-your-support' in last or 'thank you' in last:
						live += 1
